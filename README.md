...
Trouver un logement étudiant peut être un vrai casse-tête. FoyerConnect centralise l'information sur les foyers privés (chambres disponibles, photos, localisation, contact) et permet aux étudiants de :


Rechercher un foyer selon leur université
Consulter les fiches détaillées des foyers populaires
...
Base de données : MySQL (scripts SQL fournis dans sql/)
